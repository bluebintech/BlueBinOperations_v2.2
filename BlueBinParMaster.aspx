...
<%--                <EditItemTemplate>
            ...
            <asp:TemplateField HeaderText="Bin Qty" SortExpression="BinQuantity">    
                <ItemTemplate>
...
<asp:Label runat="server" id="hiddenItemMaster"><h3>Item Master</h3><p></asp:Label>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="ItemDescription2" SortExpression="ItemDescription2">
                <EditItemTemplate>
                    <asp:TextBox runat="server" Text='<%# Bind("ItemDescription2") %>' ID="EditItemDescription2"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidatorItemDescription2" ValidationGroup="EditItemDescription2" runat="server" ControlToValidate="EditItemDescription2" Display="Dynamic" ForeColor="Red" Font-Size="X-Small">REQUIRED</asp:RequiredFieldValidator>
                <ItemStyle Wrap="False" Width="150px"></ItemStyle>

                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Label runat="server" Text='<%# Bind("ItemDescription2") %>' ID="LabelItemDescription2"></asp:Label>
                </ItemTemplate>
                <FooterTemplate><asp:TextBox runat="server" ID="ItemDescription2"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidatorItemDescription2" ValidationGroup="AddItemDescription2" runat="server" ControlToValidate="ItemDescription2" Display="Dynamic" ForeColor="Red" Font-Size="X-Small">REQUIRED</asp:RequiredFieldValidator>
                    <ItemStyle Wrap="False" Width="150px"></ItemStyle>
                </FooterTemplate>
            </asp:TemplateField>
